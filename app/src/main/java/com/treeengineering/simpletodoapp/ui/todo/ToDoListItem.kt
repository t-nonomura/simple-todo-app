...
class ToDoListItem(
    ...
    override fun bind(viewBinding: ItemTodoListBinding, position: Int) {
        ...
        viewBinding.cardViewTodo.setOnClickListener { clickListener.onClickItem() }
        viewBinding.checkboxTodo.setOnClickListener { clickListener.onClickCheckbox() }
        viewBinding.imageDeleteTodo.setOnClickListener { clickListener.onClickDelete() }
    }
}
